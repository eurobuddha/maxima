 ...
 * Android Keystore that the app's SeedStore uses (a
...
public final class BackupCrypto {
    ...
    public static byte[] encrypt(byte[] zPlain, char[] zPassword) throws Exception {
    ...
    public static byte[] decrypt(byte[] zBlob, char[] zPassword) throws Exception {
        int m = MAGIC.length;
