...
public class MaxTxPoW implements Streamable {
	...
	public static MaxTxPoW createMaxTxPoW(MaximaPackage zMaxima) {		
		...
		//maxjar: chain-free carrier - see org.minima.objects.TxPoW
		...
		//maxjar: no chain tip - the Magic floor is a protocol constant
		MiniData minwork = Magic.MIN_TXPOW_WORK;
		...
		//Now Mine it..
		//maxjar: in-process miner replaces Main.getTxPoWMiner()
		boolean valid = txpow.mineMaxTxPoW(mMaxTimeMilli);
		if(!valid) {
			return null;
		}
