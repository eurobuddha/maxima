...
public final class ImageLoader {
    ...
    public static void load(final WalletActivity act, final String url, final ImageView iv, int fallbackRes) {
        load(act, url, iv, fallbackRes, THUMB_PX);
    }

    /** Full-resolution load (bounded to FULL_PX) for an NFT image view. */
    public static void loadFull(final WalletActivity act, final String url, final ImageView iv, int fallbackRes) {
    ...
    public static void loadOver(final WalletActivity act, final String url, final ImageView iv, final Runnable onLoaded) {
        iv.setTag(url);
    ...
    private static void load(final WalletActivity act, final String url, final ImageView iv, int fallbackRes, final int reqPx) {
        iv.setTag(url);
